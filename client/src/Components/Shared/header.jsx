...

        {
          props.currentUser ? (
            <>
              ...
              <li className="head-li welcome"> Welcome, <Link className="user-click" to={`/users/${props.currentUser.id}`}>{props.currentUser.username}</Link><button className="logout button" onClick={handleLogout}>Logout</button></li>
